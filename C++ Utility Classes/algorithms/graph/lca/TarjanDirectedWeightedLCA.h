...
private:
    ...
    void dfs(WeightedDigraph *G, int v, int prev) {
        ancestor[v] = v;
...
public:
    TarjanDirectedWeightedLCA(WeightedDigraph *G, vector<pair<int, int>> queries) : answers(queries.size()) {
