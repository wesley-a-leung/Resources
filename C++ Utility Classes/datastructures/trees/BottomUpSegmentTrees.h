#ifndef DATASTRUCTURES_TREES_BOTTOMUPSEGMENTTREES_H_
#define DATASTRUCTURES_TREES_BOTTOMUPSEGMENTTREES_H_
...
public:
    SegmentTree_RAM_RQ(int size, int *A, bool oneIndexed) {
        N = size;
        T = new int[2 * N];
        L = new int[N];
        H = 0;
...
#endif /* DATASTRUCTURES_TREES_BOTTOMUPSEGMENTTREES_H_ */
