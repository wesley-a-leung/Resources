...
/**
 *  The {@code DijkstraLP} class represents a data type for solving the
 *  single-source longest paths problem in edge-weighted digraphs
 *  where the edge weights are nonnegative (the algorithms turns the positive weights to negative.
 *  <p>
