...
public class SeparateChainingHashTable<Key, Value> {
    ...
    private SeparateChainingHashTable<Key, Value>[] st;  // array of linked-list symbol tables
    ...
    public SeparateChainingHashTable(int m) {
        this.m = m;
        st = (SeparateChainingHashTable<Key, Value>[]) new SeparateChainingHashTable[m];
        for (int i = 0; i < m; i++)
            st[i] = new SeparateChainingHashTable<Key, Value>();
    } 
