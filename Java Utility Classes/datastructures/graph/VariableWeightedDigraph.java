...
/**
 *  The {@code VariableWeightedDigraph} class represents a variable/mutable edge-weighted
 ...
 *  @author Wesley Leung
 */
public class VariableWeightedDigraph {
     ...
     */
    public VariableWeightedDigraph(int V) {
     ...
     */
    public VariableWeightedDigraph(VariableWeightedDigraph G) {
        this(G.V());
        this.E = G.E();
        for (int v = 0; v < G.V(); v++)
