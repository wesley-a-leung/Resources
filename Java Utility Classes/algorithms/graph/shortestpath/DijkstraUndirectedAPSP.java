...
/**
 *  The {@code DijkstraUndirectedAPSP} class represents a data type for solving the
 ...
 *  @author Kevin Wayne
 */
public class DijkstraUndirectedAPSP {
     ...
     */
    public DijkstraUndirectedAPSP(WeightedGraph G) {
