...
/**
 *  The {@code DijkstraVariableSP} class represents a data type for solving the
 *  single-source shortest paths problem in variable edge-weighted variable digraphs
 ...
 *  @author Kevin Wayne
 */
public class DijkstraVariableSP {
