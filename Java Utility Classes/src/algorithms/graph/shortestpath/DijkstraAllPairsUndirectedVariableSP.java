...
/**
 *  The {@code DijkstraAllPairsUndirectedVariableSP} class represents a data type for solving the
 *  all-pairs shortest paths problem in variable edge-weighted graphs
 ...
 *  @author Kevin Wayne
 */
public class DijkstraAllPairsUndirectedVariableSP {
    private DijkstraUndirectedVariableSP[] all;

    /**
     * Computes a shortest paths tree from each vertex to to every other vertex in
     * the variable edge-weighted graph {@code G}.
     * @param G the variable edge-weighted graph
