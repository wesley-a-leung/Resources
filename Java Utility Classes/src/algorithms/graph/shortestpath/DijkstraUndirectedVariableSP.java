...
/**
 *  The {@code DijkstraVariableUndirectedSP} class represents a data type for solving
 *  the single-source shortest paths problem in edge-weighted variable graphs
...
public class DijkstraUndirectedVariableSP {
     ...
     */
    public DijkstraUndirectedVariableSP(VariableEdgeWeightedGraph G, int s) {
    ...
    private boolean check(VariableEdgeWeightedGraph G, int s) {
