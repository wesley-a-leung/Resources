 ...
 *  all-pairs shortest paths problem in variable edge-weighted digraphs
 ...
 *  @author Kevin Wayne
 */
public class DijkstraAllPairsVariableSP {
    private DijkstraVariableSP[] all;
     ...
     */
    public DijkstraAllPairsVariableSP(VariableEdgeWeightedDigraph G) {
        all  = new DijkstraVariableSP[G.V()];
        for (int v = 0; v < G.V(); v++)
            all[v] = new DijkstraVariableSP(G, v);
    }
