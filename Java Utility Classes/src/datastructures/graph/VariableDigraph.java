...
public class VariableDigraph {
     ...
     */
    public VariableDigraph(VariableDigraph G) {
        this(G.V());
        this.E = G.E();
        for (int v = 0; v < V; v++)
     ...
     */
    public VariableDigraph reverse() {
        VariableDigraph reverse = new VariableDigraph(V);
        for (int v = 0; v < V; v++) {
            for (int w : adj(v)) {
                reverse.addEdge(w, v);
            }
